...
struct MemoryEditor
{
    ...
    bool DrawWindow(const char* title, void* mem_data, size_t mem_size, const char* FileName, size_t base_display_addr = 0x0000)
    {
        Sizes s;
        ...
        if (ImGui::Begin(title, &Open, ImGuiWindowFlags_NoScrollbar))
        {
			...
			ImGui::BeginChild("FileName", ImVec2(ImGui::GetWindowWidth(), 20), false, ImGuiWindowFlags_NoScrollbar);
			ImGui::Text(FileName);
			ImGui::EndChild();
